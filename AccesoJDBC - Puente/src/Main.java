...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Connection conexion = DriverManager.getConnection("jdbc:mysql://172.16.100.5:3306/ignacio", "ignacio", "ignacio");
	...
	private static void insertarDepartamento(Connection conexion, String nombredep) throws SQLException {
		...
		if(insertar == null){
			insertar = conexion.prepareStatement("INSERT INTO departamentos (nombre) VALUES (?)", PreparedStatement.RETURN_GENERATED_KEYS);
